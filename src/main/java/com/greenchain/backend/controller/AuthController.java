    ...
    public ResponseEntity<?> login(@RequestBody User loginUser) {
        ...
        if (user != null) {
            ...
            if (passwordMatch) {
                ...
                // If password doesn't match, check if it's the plain text password (admin123 or
                // supplier123)
                if ("admin123".equals(password) || "supplier123".equals(password) || "viewer123".equals(password)) {
